...
class VisualizationTab(QWidget):
    ...
    def setup_ui(self):
        ...
        source_frame = QFrame()
        source_frame.setStyleSheet("QFrame { background-color: #3c3c3c; border-radius: 5px; padding: 10px; }")
        source_layout = QVBoxLayout(source_frame)
        
        source_label = QLabel("Выбор источника видео:")
        source_label.setStyleSheet("font-weight: bold; font-size: 14px; color: white;")
        ...
        self.source_info_label.setStyleSheet("color: #cccccc; font-size: 12px;")
        ...
        self.video_label.setStyleSheet("border: 2px solid gray; background-color: #1e1e1e; color: white;")
        ...
        info_label.setStyleSheet("font-weight: bold; font-size: 14px; color: white;")
        right_layout.addWidget(info_label)
        
        self.info_text = QTextEdit()
        self.info_text.setMaximumHeight(200)
        self.info_text.setReadOnly(True)
        self.info_text.setStyleSheet("background-color: #1e1e1e; color: #d4d4d4;")
        right_layout.addWidget(self.info_text)
        
        # Лог операцийй
        log_label = QLabel("Лог операций:")
        log_label.setStyleSheet("font-weight: bold; font-size: 14px; color: white;")
